...
evnames{8} = 'us_nonT_2';
evnames{9} = 'us_nonT_3';
evnames{10} = 'us_nonT_4';
evnames{11} = 'us_nonT_5';
evnames{12} = 'us_nonT_6';
...
%     % % the contrasts themselves for 2BACK
    ...
    ctype{1} = 'T';
    connames{1} = 'at_nonT_1_2-us_nonT_1_2';
%     
    tmp = sz;
    tmp(9:10) = -1;
    tmp(5:6)=1;
    ...
    ctype{2} = 'T';
    connames{2} = 'at_nonT_3_4-us_nonT_3_4';
%     
    tmp = sz;
    tmp(7:10) = -1;
    tmp(3:6)=1;
    ...
    ctype{3} = 'T';
    connames{3} = 'at_nonT_all4-us_nonT_all4';
%     
    tmp = sz;
    tmp(13:14) = -1;
    tmp(15:16)=1;
...
%
    ...
    ctype{5} = 'T';
    connames{5} = 'at_nonT_1_2-nt_nonT_1_2';
%    
    tmp = sz;
    tmp(1:2) = -1;
    tmp(7:8)=1;
    ...
    ctype{6} = 'T';
    connames{6} = 'us_nonT_1_2-nt_nonT_1_2';
...
%     con{7} = repmat([tmp mz],1,nsess);
%     ctype{7} = 'T';
%     connames{7} = 'us_nonT_1_2-nt_nonT_1_2';
% %
%     tmp = sz;
%     tmp(1) = -1;
%     tmp(9)=1;
