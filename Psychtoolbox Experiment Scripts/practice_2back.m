...
% sub_nb = inputdlg('id?');
%%cd('D:\aa02');
filename = 'sub22_practice';%strcat(sub_nb,'_');
...
WMdur = 30;%%%%%%%%%%%%%%%%%%%%%
RestAfter = 3;%%%%%%%%%%%%%%%
pic_folder = '/Users/ozge/Desktop/Study2/pics';
% rest_pics_folder = 'C:\Users\MR_stimulus\Desktop\Ipek\faces\xpresented';
pics=dir('/Users/ozge/Desktop/Study2/pics/*.jpg');%list files in the folder
...
for i = 1:1
    ...
    DrawFormattedText(window, num2str(16-i), 'center', yCenter+150,[0 0 0],[]);
...
for Blocks = 1:1
    ...
    for Episode = 1:CurrBlockLen
        ...
        while buttonpress==0
            ...
            elseif keyCode(Key.Z)
                buttonpress=1;
                
                
                break;
                
            elseif keyCode(Key.X)
                buttonpress=1;
                
                
                break;
            elseif keyCode(Key.C)
                buttonpress=1;
                
                
                break;
                
            elseif keyCode(Key.V)
                buttonpress=1;
        ...
        %get 9 pictures
        currlist = datasample(piclist,6,'Replace',false);
        ...
        if numTs>1
            ...
            a = (find(trials(3:6)==1))+2;
            if rem(Episode,2)==0
                currpic{a(2)} = currpics{20};
                currpic{a(1)} = currpics{22};
            else
                currpic{a(2)} = currpics{19};
                currpic{a(1)} = currpics{21};
