...
rootdir = 'G:\OZGE_STUDY2\statsfir2';   %main analysis directory
roidir = 'G:\OZGE_STUDY2\ROI';%'/imaging/aa02/TM3/AA/ROIS';% directory containing roi.mat files
resdir = 'G:\OZGE_STUDY2\statsfir2\roi_results_all3back';
...
subs = {'sub01','sub02','sub03','sub04','sub23','sub24','sub25','sub26','sub27','sub28','sub29','sub30','sub31','sub32','sub33'};
subs = char(subs);
