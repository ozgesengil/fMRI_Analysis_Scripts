...
%rootdir = 'E:\fMRI\fr-pr-3-AA\HCFprep\A_block\studyA_3D\aamod_firstlevel_model_00001';
rootdir = 'G:\OZGE_STUDY2\newstats3';%main analysis directory
img_path = 'G:\OZGE_STUDY2';
roidir = 'G:\OZGE_STUDY2\ROI';%'/imaging/aa02/TM3/AA/ROIS';% directory containing roi.mat files
resdir = fullfile(pwd,'roi_results_newstats3_sub23to33');
...
subs = {'sub23','sub24','sub25','sub26','sub27','sub28','sub29','sub30','sub31','sub32','sub33'};
...
for s=1:nsubs
    ...
    D = mardo(desfile);
    D = cd_images(D, fullfile(img_path,csub));
    save_spm(D);
    
% % %     desfile = fullfile(rootdir,csub,'stats','SPM.mat');
% % %     SPM = load(desfile);
% % %     D = mardo(SPM);
