...
results_dir = 'G:\OZGE_STUDY2\resultsMVPA1_2_searchlight';

% Set the filepath where your SPM.mat and all related betas are, e.g. 'c:\exp\glm\model_button'
higher_beta_loc = 'G:\OZGE_STUDY2\statsMVPA1_2'; % where all subs' first level results are


subs = {'sub30','sub31','sub32','sub33'};
subs = char(subs);
