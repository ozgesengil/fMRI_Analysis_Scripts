...
results_dir = 'G:\OZGE_STUDY2\resultsMVPA6searchlight_nochunks\2back_0T5-0T6';

% Set the filepath where your SPM.mat and all related betas are, e.g. 'c:\exp\glm\model_button'
higher_beta_loc = 'G:\OZGE_STUDY2\statsMVPA6_nochunks'; % where all subs' first level results are

subs = {'sub06','sub07','sub08','sub09','sub10','sub11','sub12','sub13','sub14','sub15','sub16','sub17','sub18','sub19','sub20','sub21','sub22'};
% subs = {'sub11','sub12','sub13','sub14','sub16','sub17','sub18','sub19','sub20','sub21','sub22'};
...
% labelvalue4 = 4; % value for labelname4
% labelvalue5 = 3; % value for labelname1
% labelvalue6 = 3; % value for labelname2
% labelvalue7 = 4; % value for labelname3
% labelvalue8 = 4; % value for labelname4
% labelvalue9 = 5; % value for labelname1
% labelvalue10 = 5; % value for labelname2
% labelvalue11 = 6; % value for labelname3
% labelvalue12 = 6; % value for labelname4
% labelvalue13 = 7; % value for labelname1
% labelvalue14 = 7; % value for labelname2
