...
firstlevel_dir = '/imaging/aa02/TM5/AA_alt/aamod_firstlevel_model_00001';
cd(firstlevel_dir);
subject_folders = dir('190*');
subject_folders = {subject_folders(1:end).name};

list = 1:16;
test_lists = [1:4;5:8;9:12; 13:16];
...
for sub = 1:numel(subject_folders)
    ...
    if (size(type_all{1},2) |size(type_all{2},2))<16
        list = 1:12;
