...
results_dir = 'F:\OZGE_STUDY2\resultsMVPA2_2_searchlight';

% Set the filepath where your SPM.mat and all related betas are, e.g. 'c:\exp\glm\model_button'
higher_beta_loc = 'F:\OZGE_STUDY2\statsMVPA2_2'; % where all subs' first level results are


subs = {'sub02','sub03','sub04','sub06','sub07','sub08','sub09','sub10','sub11','sub12','sub13','sub14','sub15','sub16','sub17','sub18','sub19','sub20','sub21','sub22'};
subs = char(subs);
