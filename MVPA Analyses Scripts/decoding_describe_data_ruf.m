...
% % % % % % %             labelnames{i_input} =
% wildcard2regexp(orig_labelnames{i_input});%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        end
        ...
        cfg.files.chunk = [cfg.files.chunk 1:length(cell2mat(regressor_names(2,label_index)))]; %%[cfg.files.chunk cell2mat(regressor_names(2,label_index))];%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
