...
firstlevel_dir = 'G:\OZGE_STUDY2\statsMVPA3';
cd(firstlevel_dir);
% subject_folders = dir;
...
% % subject_folders =  {'sub02','sub03','sub04','sub23','sub24','sub25','sub26','sub27','sub28','sub29','sub30','sub31','sub32'};
% sessnums=[3 3 3 3 4 4 3 3 3 3 3 3 3];
% % % sessnums=[3 3 3 3 3 4 4 3 3 3 3 3 3];

subject_folders = {'sub06','sub07','sub08','sub09','sub10','sub11','sub12','sub13','sub14','sub15','sub16','sub17','sub18','sub19','sub20','sub21','sub22','sub27','sub28','sub29','sub30','sub31','sub32','sub33'};
sessnums=[4 2 4 4 3 4 3 4 4 4 4 4 4 4 4 4 4 3 3 3 3 3 3 3];
