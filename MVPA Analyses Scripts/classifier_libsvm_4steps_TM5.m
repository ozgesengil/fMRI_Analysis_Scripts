...
firstlevel_dir = '/imaging/aa02/TM5/AA/trl_identity_4chnks';
cd(firstlevel_dir);
subject_folders = dir('190*');
subject_folders = {subject_folders(1:end).name};

list = 1:44;
test_lists = [1:4;5:8;9:12;13:16;17:20;21:24;25:28;29:32;33:36;37:40;41:44];
test_lists_alt = [41:44; 37:40; 33:36; 29:32; 25:28; 21:24; 17:20; 13:16; 9:12; 5:8; 1:4];
...
%                 
%                 [predicted,accuracy,~]=svmpredict(labels_test',patternsTest,model);
%                 accuracy_fold(i+12,p)=accuracy(1);
%                 
%                 
%             end
%             
