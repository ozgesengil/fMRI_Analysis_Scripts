...
results_dir = 'G:\OZGE_STUDY2\resultsMVPA3searchlight';

% Set the filepath where your SPM.mat and all related betas are, e.g. 'c:\exp\glm\model_button'
higher_beta_loc = 'G:\OZGE_STUDY2\statsMVPA3'; % where all subs' first level results are


subs = {'sub06','sub07','sub08','sub09','sub10','sub11','sub12','sub13','sub14','sub15','sub16','sub17','sub18','sub19','sub20','sub21','sub22','sub27','sub28','sub29','sub30','sub31','sub32','sub33'};
subs = char(subs);
