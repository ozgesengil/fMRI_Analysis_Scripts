...
statsdir ='E:\OZGE_STUDY2\statsNAT';           % directory for analysis results
evdir = 'E:\OZGE_STUDY2\eventsNAT';     % directory with event onset files
...
evnames{8} = 'at_nonT_6';
evnames{9} = 'at_nonT_7';
evnames{10} = 'at_nonT_8';
evnames{11} = 'at_nonT_9';

evnames{12} = 'us_nonT_1';
evnames{13} = 'us_nonT_2';
evnames{14} = 'us_nonT_3';
evnames{15} = 'us_nonT_4';
evnames{16} = 'us_nonT_5';
evnames{17} = 'us_nonT_6';
evnames{18} = 'us_nonT_7';
evnames{19} = 'us_nonT_8';
evnames{20} = 'us_nonT_9';
...
for sub = 1:ntot               % loop through subjects
    ...
    Sess = dir(fullfile(rootdir,csub,'SESS*'));
  ...
  %     % % the contrasts themselves for 3BACK
    tmp = sz;
    tmp(21) = -1;
    tmp(24)=1;
    con{1} = repmat([tmp mz],1,nsess);
    ctype{1} = 'T';
    connames{1} = 'at_T_1-us_T_1';
%     
    tmp = sz;
    tmp(22) = -1;
    tmp(25)=1;
...
%
    ...
    ctype{5} = 'T';
    connames{5} = 'at_nonT_1-nt_nonT_1';
%    
    tmp = sz;
    tmp(2) = -1;
    tmp(4)=1;
    ...
    ctype{6} = 'T';
    connames{6} = 'at_nonT_2-nt_nonT_2';
%
    tmp = sz;
    tmp(1:2) = -1;
    tmp(3:4)=1;
...
%
    ...
    ctype{8} = 'T';
    connames{8} = 'us_nonT_1-nt_nonT_1';
%    
    tmp = sz;
    tmp(2) = -1;
    tmp(13)=1;
    con{9} = repmat([tmp mz],1,nsess);
    ctype{9} = 'T';
    connames{9} = 'us_nonT_2-nt_nonT_2';
%
    tmp = sz;
    tmp(1:2) = -1;
    tmp(12:13)=1;
    con{10} = repmat([tmp mz],1,nsess);
    ctype{10} = 'T';
    connames{10} = 'us_nonT-nt_nonT';
%
    tmp = sz;
    tmp(12:20) = -1;
    tmp(3:11)=1;
    con{11} = repmat([tmp mz],1,nsess);
    ctype{11} = 'T';
    connames{11} = 'at_nonT-us_nonT';
%
