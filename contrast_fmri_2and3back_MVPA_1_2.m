...
statsdir ='F:\OZGE_STUDY2\statsMVPA1_2';           % directory for analysis results
...
imgfilt = 'arf*.nii';    % prefix for images to be used in the analysis
...
subs = {'sub11','sub12','sub13','sub14','sub15','sub16','sub17','sub18','sub19','sub20','sub21','sub22','sub25','sub26'};
subs = char(subs);
