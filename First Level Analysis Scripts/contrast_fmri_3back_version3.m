...
statsdir ='E:\OZGE_STUDY2\newstats3';           % directory for analysis results
evdir = 'E:\OZGE_STUDY2\events2';     % directory with event onset files
...
%     
    tmp = sz;
    tmp(1:9) = -2;                  %%%??? can I form the model like that?
    tmp(13:14)= 9;
