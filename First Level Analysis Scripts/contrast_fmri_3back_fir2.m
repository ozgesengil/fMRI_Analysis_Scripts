% used for participants sub01, sub02, sub03, sub04
...
statsdir ='E:\OZGE_STUDY2\statsfir2';           % directory for analysis results
evdir = 'E:\OZGE_STUDY2\eventsfir2';     % directory with event onset files
...
myxBF(1).length = 46; % length in seconds
myxBF(1).order = 23; % order of basis set
