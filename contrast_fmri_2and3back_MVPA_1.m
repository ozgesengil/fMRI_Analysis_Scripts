...
rootdir = 'F:\OZGE_STUDY2';        % top level study directory
statsdir ='F:\OZGE_STUDY2\statsMVPA1';           % directory for analysis results
evdir = 'F:\OZGE_STUDY2\eventsMVPA1';     % directory with event onset files
...
imgfilt = 'warf*.nii';    % prefix for images to be used in the analysis
...
subs = {'sub02','sub03','sub04','sub06','sub07','sub08','sub09','sub10','sub11','sub12','sub13','sub14','sub15','sub16','sub17','sub18','sub19','sub20','sub21','sub22','sub23','sub24','sub25','sub26'};
subs = char(subs);
